                        ...
                        <form action="validar_admin.php" method="post" accept-charset="utf-8" class="custom-form contact-form " role="form">
                            ...
                            <div class="mb-3">
                                <div class="input-group input-group-merge">
                                    <div class="form-floating">
                                        <input type="password" class="form-control bg-light border-0" placeholder="Contraseña" name="passAdmin" id="passAdmin"  required>
                                        <label class="form-label">Contraseña</label>
                                    </div>
                                    <button  class="input-group-text form" type="button" onclick="mostrarPasswordLoginAdmin()"> <span class="bi bi-eye-slash" id="togglePasswordA"></span> </button>
                                </div>
                            </div>
