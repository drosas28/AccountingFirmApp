                ...
                <div class="col-lg-12 col-12 mx-auto text-center">
                    ...
                    <nav class="d-flex justify-content-center">
                        ...
                        <div class="nav nav-tabs align-items-baseline justify-content-center" id="nav-tab" role="tablist">
                            <button class="nav-link " id="nav-RegisForm-tab" data-bs-toggle="tab" data-bs-target="#nav-RegisForm" aria-controls="nav-RegisForm" aria-selected="false">
                                <h5>Registro</h5>
                            </button>

                            <button class="nav-link active" id="nav-Ingreso-tab" data-bs-toggle="tab" data-bs-target="#nav-Ingreso" type="button" role="tab" aria-controls="nav-Ingreso" aria-selected="false">
                                <h5>Ingresar</h5>
                            </button>
                        </div>
                    </nav>
                    ...
                    <div class="tab-content shadow-lg mt-5 justify-content-center col-lg-7 mx-auto" id="nav-tabContent">
                        <div class="tab-pane fade" id="nav-RegisForm" role="tabpanel" aria-labelledby="nav-RegisForm-tab">
                        ...
                        <div class="tab-pane fade show active justify-content-center mt-5 col-lg-7 mx-auto" id="nav-Ingreso" role="tabpanel" aria-labelledby="nav-Ingreso-tab">
