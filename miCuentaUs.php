...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light1 navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="miCuentaUs.php" class=" nav-link active"><i class="bi bi-person-bounding-box me-2"></i>Cuenta</a>
                </div>
                        ...
                        <div class="col-14">
                            <div class="h-100 bg-light1 rounded p-4">
                                <div class="d-felx align-items-center justify-content-between mb-4">
                                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Detalles del Perfil</span></h4>
                                </div>
                                <div>
    ...
    <script>
        ...
        function datosFormulario (id){
            let url = "http://localhost/ProyectoWeb/conexion_DB/usuarios.php?tipo=5&id=" + id;
            $.ajax({url:url,success:function(result){
                ...
                miform+='                   <input class="form-control" type="text" id="nombre" name="nombre" value="'+result.item[0].nombre + '">';
                miform+='               </div>';
                miform+='               <div class="mb-3 col-md-3">';
                ...
                miform+='                   <input type="email" class="form-control" id="email" name="email"  pattern="[^ @]*@[^ @]*" value="'+result.item[0].correo+'"/>';
                miform+='               </div>';
                miform+='               <div class="mb-3 col-md-6">';
        ...
        function modificar(){
            ...
            if (nom != "" && ap != "" && am != "" && us != "" && dir != "" && email != "" && tel != "" && tel_l != "" && pass != ""){
                let url1 = "http://localhost/ProyectoWeb/conexion_DB/clientes.php?tipo=4&id=" +id + "&nom=" +nom+ "&a_p=" +ap+ "&a_m=" +am+ "&us=" +us+ "&dir=" +dir+ "&cor=" +email+ "&num_tel=" +tel+ "&num_l=" +tel_l+ "&r=" + Math.random(); 
                let url2 = "http://localhost/ProyectoWeb/conexion_DB/usuarios.php?tipo=4&id=" +id+ "&us=" +us+ "&pass=" +pass+ "&r=" + Math.random();
